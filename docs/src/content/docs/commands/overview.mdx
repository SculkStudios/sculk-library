...
:::note
Commands currently register through Bukkit's command map. A Brigadier/Paper command API integration is planned, but it is not part of the current command system.
:::
