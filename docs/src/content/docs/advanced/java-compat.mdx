...
description: Guide to using the Java-friendly Sculk Studio APIs from Java plugins.
---

import { Tabs, TabItem } from '@astrojs/starlight/components';

Sculk Studio is Kotlin-first, but the core platform, command, GUI, config, and data APIs include Java-friendly entry points. Prefer the `Java*` builders shown here when a Kotlin DSL would be awkward from Java.
