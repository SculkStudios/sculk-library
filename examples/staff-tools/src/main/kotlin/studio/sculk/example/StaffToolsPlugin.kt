...
public class StaffToolsPlugin : SculkPlugin({ gui() }) {
    ...
    private fun staffCommand() = command("staff") {
    ...
    private fun freezeCommand() = command("freeze") {
    ...
    private fun inspectCommand() = command("inspect") {
    ...
    private fun staffChatCommand() = command("staffchat") {
