...
class ProfileServiceTest {
    ...
    private class MemoryRepository : SculkRepository<PlayerProfile, UUID> {
        ...
        override fun find(id: UUID): SculkResult<PlayerProfile?> = SculkResult.success(values[id])

        override fun findAll(): SculkResult<List<PlayerProfile>> = SculkResult.success(values.values.toList())

        override fun save(entity: PlayerProfile): SculkResult<Unit> {
        ...
        override fun saveAll(entities: List<PlayerProfile>): SculkResult<Unit> {
