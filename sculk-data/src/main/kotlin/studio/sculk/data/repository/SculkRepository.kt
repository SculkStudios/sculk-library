 ...
 * (e.g. inside a [studio.sculk.core.scheduler.SculkScheduler.runAsync] block).
 *
 * Java users should use the [studio.sculk.data.java.JavaRepository] wrapper which returns
