...
public class PacketEventsPacketServiceProvider : SculkPacketServiceProvider {
    ...
    override fun isAvailable(): Boolean =
        classExists("com.github.retrooper.packetevents.PacketEvents") &&
...
private class PacketEventsPacketService(
    ...
    private fun ProtocolPacketEvent.toContext(
        direction: PacketDirection,
        type: PacketKey,
    ): PacketContext =
        PacketContext(
    ...
    private fun PacketPriority.toPacketEvents(): PacketListenerPriority =
        when (this) {
