...
internal constructor(
    ...
    @SculkStable
    public fun component(language: String, key: String, vararg placeholders: Pair<String, String>): Component {
    ...
    @SculkStable
    public fun component(player: Player, key: String, vararg placeholders: Pair<String, String>): Component =
        component(languageOf(player), key, *placeholders)

    /** Renders a pluralized [key] (`key.one` / `key.other`) for [count], substituting `<count>`. */
    @SculkStable
    public fun plural(player: Player, key: String, count: Int, vararg placeholders: Pair<String, String>): Component {
    ...
    private fun substitute(template: String, placeholders: Map<String, String>): String =
        placeholders.entries.fold(template) { acc, (k, v) -> acc.replace("<$k>", v) }

    @Suppress("UNCHECKED_CAST")
    private fun flatten(raw: Map<String, Any?>, prefix: String = ""): Map<String, String> {
